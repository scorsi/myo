...
class Engine 
{
	...
	private function displayAction(action:ActionType, textField:TextField)
	{
		switch (action) 
		{
			...
			case ActionType.Equip(weapon) :
				textField.text = 'Equips ${weapon.getName()}';
		}
		textField.alpha = 1;
	}
